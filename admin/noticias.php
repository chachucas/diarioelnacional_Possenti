       ...
       */
        ...
        for($i=0;$i<$nfilas;$i++)
        {
            ...
            <tr>
                ...
                <td><a href="noticias_borrar.php?id_noticia='.$resultado['id_noticia'].'&imagen='.$resultado['imagen'].'" class="btn btn-danger" onclick="return confirm(&quot;¿Desea eliminar esta noticia?&quot;)">borrar</a></td>
            </tr>
