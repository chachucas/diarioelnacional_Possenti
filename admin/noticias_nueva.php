    ...
    <div class="container">
        ...
        <form action="noticias_nueva_guardar.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="copete" name="copete" placeholder="Ingrese el copete" required>
            </div>
            <div class="mb-3">
                <label for="cuerpo" class="form-label">cuerpo</label>
                <textarea  rows="10" class="form-control" id="cuerpo" name="cuerpo" placeholder="Cuerpo" required></textarea>
            </div>
            <div class="mb-3">
